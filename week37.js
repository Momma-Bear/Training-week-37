...
for (let index = max; index > 0; index--) {
    ...
    console.log((index - 1) + " bottles of soda on the shelf")
    console.log("");
}
...
let contacts = [98532781, 24220000, 37829436];
...
for(i = 0; i < peopleNames.length; i++){
    let lastInArray = peopleNames[i].length - 1;
    let lastName = peopleNames[i][lastInArray];
